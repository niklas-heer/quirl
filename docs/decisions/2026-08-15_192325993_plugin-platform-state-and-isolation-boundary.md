+++
schema_version = 1
id = "01M2XHZ6X9CX8E33B8TZ11VNR0"
title = "Plugin platform state and isolation boundary"
date = "2026-08-15"
status = "accepted"
tags = ["architecture", "security", "extension"]
supersedes = []
superseded_by = []
depends_on = ["01M2XHZ6WRQNS9VTHY13TCBSBE", "01M2XHZ6X40KK4EECMJ9G6XR85"]
related_to = []
+++
- Extends: [ADR 0002](2026-08-15_192325976_enforce-one-way-crate-layering.md), [ADR 0004](2026-08-15_192325988_phase-2-contract-and-language-service-layers.md)
