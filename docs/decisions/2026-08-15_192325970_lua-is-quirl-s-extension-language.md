+++
schema_version = 1
id = "01M2XHZ6WJK6NX55ZDF8XQ4960"
title = "Lua is Quirl's extension language"
date = "2026-08-15"
status = "accepted"
tags = ["extension"]
supersedes = []
superseded_by = []
depends_on = []
related_to = ["01M2XHZ71MB67JYBFJESQ4BSE6"]
+++
- Decision owners: Quirl maintainers
- Superseded in part: the Lua 5.4 runtime pin is replaced by Lua 5.5.1 in
  [ADR 0027](2026-08-26_192326132_advance-the-embedded-runtime-to-lua-5-5-1.md)
