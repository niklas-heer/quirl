+++
schema_version = 1
id = "01M2XHZ6X40KK4EECMJ9G6XR85"
title = "Phase 2 contract and language-service layers"
date = "2026-08-15"
status = "accepted"
tags = ["architecture"]
supersedes = []
superseded_by = []
depends_on = ["01M2XHZ6WRQNS9VTHY13TCBSBE"]
related_to = []
+++
- Extends: [ADR 0002](2026-08-15_192325976_enforce-one-way-crate-layering.md)
