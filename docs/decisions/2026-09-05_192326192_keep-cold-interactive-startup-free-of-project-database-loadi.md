+++
schema_version = 1
id = "01M2XHZ73GH45119JY5J887FQJ"
title = "Keep cold interactive startup free of project database loading"
date = "2026-09-05"
status = "accepted"
tags = ["performance", "storage"]
supersedes = []
superseded_by = []
depends_on = ["01M2XHZ7290CDA6GD0REK4HQGE"]
related_to = []
+++
- Applies to: interactive project cache admission and rich prompt context
- Refines: [ADR 0030](2026-09-02_192326153_bounded-automatic-project-discovery.md)
