+++
schema_version = 1
id = "01M2XHZ6XFS5RD8YVCBGMGZQAD"
title = "Platform process and recovery boundaries"
date = "2026-08-15"
status = "accepted"
tags = ["architecture"]
supersedes = []
superseded_by = []
depends_on = ["01M2XHZ6WYP05WCZ6BXVKE4AMW", "01M2XHZ6X9CX8E33B8TZ11VNR0"]
related_to = ["01M2XHZ6Z9746X4SH1P1PET9C7"]
+++
- Extends: [ADR 0003](2026-08-15_192325982_preview-runtime-layers.md), [ADR 0005](2026-08-15_192325993_plugin-platform-state-and-isolation-boundary.md)
- Ownership reconciliation: [ADR 0016](2026-08-16_192326057_reconcile-runtime-layering-and-ownership-contracts.md)
...
- Windows cross-compiles against a best-effort native lifecycle backend with
  ...
  [ADR 0010](2026-08-16_192326022_freeze-the-1-0-release-scope-around-unix-and-explicit-dialec.md), this backend is portability work,
