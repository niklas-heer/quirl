+++
schema_version = 1
id = "01M2XHZ73QWP12MVYBMQT3408Y"
title = "Track release binary size without a project hard ceiling"
date = "2026-09-05"
status = "accepted"
...
superseded_by = []
depends_on = []
related_to = ["01M2XHZ739XE8J67SZDYRYH2Q0"]
+++
- Decision owners: Quirl maintainers
- Supersedes in part: the executable ceiling in [ADR 0034](2026-09-05_192326185_preserve-features-with-a-12-mib-release-binary-ceiling.md)
