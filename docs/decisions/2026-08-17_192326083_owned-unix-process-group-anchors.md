+++
schema_version = 1
id = "01M2XHZ703RAK1JA9X3N0NFH2R"
title = "Owned Unix process-group anchors"
date = "2026-08-17"
status = "accepted"
tags = ["ci"]
supersedes = []
superseded_by = []
depends_on = ["01M2XHZ6XFS5RD8YVCBGMGZQAD", "01M2XHZ6Z9746X4SH1P1PET9C7"]
related_to = []
+++
- Extends: [ADR 0006](2026-08-15_192325999_platform-process-and-recovery-boundaries.md),
  [ADR 0016](2026-08-16_192326057_reconcile-runtime-layering-and-ownership-contracts.md)
