+++
schema_version = 1
id = "01M2XHZ739XE8J67SZDYRYH2Q0"
title = "Preserve features with a 12 MiB release-binary ceiling"
date = "2026-09-05"
status = "accepted"
tags = ["release"]
supersedes = []
superseded_by = []
depends_on = []
related_to = ["01M2XHZ716PDP04MF43V2HP1V3", "01M2XHZ73QWP12MVYBMQT3408Y"]
+++
- Decision owners: Quirl maintainers
- Supersedes in part: the 10 MiB binary ceiling in the language design and ADR 0025
- Superseded in part by: [ADR 0036](2026-09-05_192326199_track-release-binary-size-without-a-project-hard-ceiling.md),
