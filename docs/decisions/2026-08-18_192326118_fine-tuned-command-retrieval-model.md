+++
schema_version = 1
id = "01M2XHZ716PDP04MF43V2HP1V3"
title = "Fine-tuned command retrieval model"
date = "2026-08-18"
status = "accepted"
tags = ["ai"]
supersedes = []
superseded_by = []
depends_on = ["01M2XHZ70A9T5C8NJBK1Y98MNF"]
related_to = []
+++
- Extends: [ADR 0021](2026-08-17_192326090_sqlite-local-command-intelligence.md)
