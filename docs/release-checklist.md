...
they must not be copied into a later candidate's evidence.
...
Linux terminal application was available, remote-PTY observations are missing,
and the real-terminal demo has not received human review. Every corresponding
box below remains unchecked. The automated real-PTY harness is supporting
evidence, not a human signoff.
