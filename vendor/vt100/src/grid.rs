...
impl Grid {
    ...
    pub fn restore_cursor(&mut self) {
        ...
        // Saved positions predate a possible resize, in either screen buffer.
        self.row_clamp_top(self.origin_mode);
        self.row_clamp_bottom(self.origin_mode);
        self.col_clamp();
    }
    ...
    pub fn scrollback_rows_discarded(&self) -> u64 {
        self.scrollback_rows_discarded
    }
        ...
        for _ in 0..(count.min(self.size.rows - self.scroll_top)) {
            ...
            if self.scrollback_len > 0 && !self.scroll_region_active() {
                ...
                while self.scrollback.len() > self.scrollback_len {
                    ...
                    self.scrollback_rows_discarded = self.scrollback_rows_discarded.saturating_add(1);
                }
