...
seriously for the supported 0.2.x release line and ongoing development.

## Supported versions

The latest immutable `0.2.x` GitHub Release is the supported release line.
Security fixes are made on `main` and included in the next exact candidate. Old commits, local forks, and untagged build
